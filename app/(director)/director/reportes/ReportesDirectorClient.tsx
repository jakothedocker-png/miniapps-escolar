...
export default function ReportesDirectorClient({ grupos, alumnosPorGrupo, escuelaId }: Props) {
  ...
  if (grupos.length === 0) {
    return (
      <div className="p-8 max-w-2xl mx-auto" style={{ background: '#F5F8FF', minHeight: '100%' }}>
        ...
        <p style={{ color: '#64748B' }}>No hay grupos registrados para esta escuela.</p>
      </div>
    )
  }
  ...
  return (
    <div className="p-6 max-w-5xl mx-auto" style={{ background: '#F5F8FF', minHeight: '100%' }}>
      <div className="mb-8">
        ...
        <p className="text-sm" style={{ color: '#64748B' }}>Genera e imprime los reportes oficiales de calificaciones de la escuela.</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="rounded-2xl p-5 flex flex-col" style={cardStyle}>
          ...
          <p className="text-xs mb-4 flex-1" style={{ color: '#64748B' }}>Todos los grupos de la escuela en un solo archivo.</p>
          <p className="text-xs font-medium mb-3" style={{ color: '#0687D8' }}>
