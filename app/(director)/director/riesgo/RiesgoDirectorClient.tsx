...
export default function RiesgoDirectorClient({ alumnos }: Props) {
  ...
  return (
    <div className="p-6 max-w-6xl mx-auto" style={{ background: '#F5F8FF', minHeight: '100%' }}>
      <div className="mb-6">
        ...
        <p className="text-sm mt-1" style={{ color: '#64748B' }}>
          Alumnos con promedio menor a 6 o con 10 o más inasistencias.
        </p>
      </div>
            ...
            <table className="w-full text-sm">
              <thead>
                <tr style={{ borderBottom: '1px solid rgba(6,135,216,0.08)' }}>
                  {['#', 'Alumno', 'Grupo', 'Maestro', 'T1', 'T2', 'T3', 'Faltas', 'Alerta'].map(h => (
                ...
                {filtrados.map((a, idx) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="px-4 py-3.5" style={{ color: '#64748B' }}>{a.maestro}</td>
