...
export default function ReportesClient({ grupos, alumnosPorGrupo }: Props) {
  ...
  if (grupos.length === 0) {
    return (
      <div style={{ background: '#F5F8FF', minHeight: '100vh' }}><div className="p-8 max-w-2xl mx-auto">
  ...
  return (
    <div style={{ background: '#F5F8FF', minHeight: '100vh' }}><div className="p-6 max-w-4xl mx-auto">
      <div className="mb-8">
